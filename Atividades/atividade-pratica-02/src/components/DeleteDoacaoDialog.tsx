...
export default function DeleteDoacaoDialog({ open, onClose, id }: Props) {

  const [info, setInfo] = React.useState<any>({});

  const deletar = async () => {
    await remove("doacoes", id);
    onClose();
  }
  ...
  return (
    <React.Fragment>
      <Dialog
        ...
        maxWidth="md"
      >
        <DialogTitle>Excluir Doação?</DialogTitle>
        <DialogContent>
            ...
            <TableContainer component={Paper}>
              <Table size="small" aria-label="a dense table">
                ...
                <TableBody>
                  ...
                  >
                    <TableCell>{info?.pessoaId}</TableCell>
