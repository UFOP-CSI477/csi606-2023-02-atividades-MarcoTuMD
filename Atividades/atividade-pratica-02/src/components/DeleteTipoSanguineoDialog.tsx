...
export default function DeleteTipoSanguineoDialog({ open, onClose, id }: Props) {

  const [info, setInfo] = React.useState<any>({});

  const deletar = async () => {
    await remove("tiposSanguineos", id);
    onClose();
  }
  ...
  return (
    <React.Fragment>
      <Dialog
        ...
        maxWidth="md"
      >
        <DialogTitle>Excluir Tipo Sanguíneo?</DialogTitle>
        <DialogContent>
              ...
              <Table size="small" aria-label="a dense table">
                ...
                <TableBody>
                  ...
                  >
                    ...
                    <TableCell>{info?.fator}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
