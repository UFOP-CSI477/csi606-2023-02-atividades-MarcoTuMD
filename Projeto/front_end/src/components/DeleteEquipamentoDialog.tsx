...
export default function DeleteEquipamentoDialog({ open, onClose, id }: Props) {
      ...
      <Table size="small" aria-label="a dense table">
        <TableHead>
          <TableRow>
            ...
            <TableCell>Data do primeiro uso</TableCell>
            <TableCell>Distância de uso</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
            <TableRow
            ...
            >
              ...
              <TableCell >{info?.dtPrimeiroUso}</TableCell>
              <TableCell>{info?.distanciaUso}</TableCell>
            </TableRow>
        </TableBody>
      </Table>
    </TableContainer>
